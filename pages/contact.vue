    ...
    <div class="bg-image page-title">
      <div class="container-fluid">
        ...
        <div class="pull-right">
          <a href="/"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="/contact">Contact Us</a>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid block-content">
      <div class="row main-grid">
        ...
        <div class="col-sm-8 wow fadeInRight" data-wow-delay="0.3s">
          ...
          <p>Integer congue elit noin semper laoreet sed lectus orcil posuer nisal tempor se felis acm Pelentesque inyd
            urna. Integer vitae felis magna po estibulm Nam rutrumc diam. Aliquam malesuada maurs.</p>
          <div id="success"></div>
